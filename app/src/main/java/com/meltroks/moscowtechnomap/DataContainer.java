...
public final class DataContainer {
    ...
    public static String[] ActiveSpots = new String[5]; // активные Имена точек (вкТест)

    public static String[] Descriptions = new String[5]; // описания ивентов

    public static String[] EventTitles = new String[5]; // имена Ивентов
}
